...
public class WalletModel implements WalletContract.WalletModel {
    @Override
    public void containData(int page, int count, final CallBack callBack) {
        ...
        Retrofit retrofit = new Retrofit.Builder()
                ...
                .baseUrl(Constant.MyWallet)
                .build();
        ApiService apiService = retrofit.create(ApiService.class);
        Observable<ResponseBody> observable = apiService.getWalletContent(userBean.getUserId(),userBean.getSessionId(),page,count);
        observable
