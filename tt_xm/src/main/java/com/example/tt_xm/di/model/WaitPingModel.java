...
public class WaitPingModel implements WaitPingContract.WaitPingModel {
    @Override
    public void containData(final CallBack callBack) {
        ...
        Observable<ResponseBody> observable = apiService.getAllOrderData(userBean.getUserId(),userBean.getSessionId(),3,1,100);
        observable
