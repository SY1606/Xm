...
public class WaitPayModel implements WaitPayContract.WaitPayModel {
    @Override
    public void containData(final CallBack callBack) {
        ...
        Observable<ResponseBody> observable = apiService.getAllOrderData(userBean.getUserId(),userBean.getSessionId(),1,1,100);
        observable
