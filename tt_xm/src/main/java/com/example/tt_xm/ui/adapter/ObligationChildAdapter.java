...
public class ObligationChildAdapter extends BaseQuickAdapter<Quorder.OrderListBean.DetailListBean,BaseViewHolder> {



    public ObligationChildAdapter(int layoutResId, @Nullable List<Quorder.OrderListBean.DetailListBean> data) {
